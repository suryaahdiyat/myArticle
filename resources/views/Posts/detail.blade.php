                ...
                <div class="flex gap-3">
                    ...
                    @else
                        @php
                            ...
                            $randomColor = sprintf('#%02X%02X%02X', mt_rand(0, 128), mt_rand(0, 128), mt_rand(0, 128));
                                    ...
                                    @if (auth()->user()->id == $post->user->id)
                                        <div class="absolute w-6 top-2 right-2 hover:cursor-pointer group">
                                            <div class="flex items-center justify-around" onclick="handleClickDel()">
                                                <div
                                                    class="w-1 h-1 duration-100 bg-gray-700 rounded-full group-hover:-translate-x-2">
                                                </div>
                                                <div
                                                    class="w-1 h-1 duration-100 delay-75 bg-gray-700 rounded-full group-hover:-translate-x-2">
                                                </div>
                                                <div
                                                    class="w-1 h-1 duration-100 delay-150 bg-gray-700 rounded-full group-hover:-translate-x-2">
                                                </div>
                                            </div>
                                            <div class="relative text-rose-700">
                                                <form id="btnDel"
                                                    class="absolute hidden p-2 bg-gray-800 rounded shadow-md top-1 right-1"
                                                    method="POST" action="/comments/{{ $comment->id }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            ...
                                                            class="size-6 group-hover:text-rose-500">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
